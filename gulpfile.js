...
gulp.task('watch', ['watch:styles', 'watch:scripts', 'watch:images', 'watch:html', 'watch:src']);

/**
 * Build Tasks
 */
gulp.task('default', callback => {
  runSequence(['clean:images', 'clean:scripts', 'copy'], ['styles', 'scripts', 'imagemin', 'html'], 'browser-sync', 'watch', callback);
});

gulp.task('build', callback => {
  runSequence(['clean:images', 'clean:scripts', 'copy'], ['styles', 'scripts', 'imagemin', 'html'], ['htmlmin', 'revision'], callback);
});
